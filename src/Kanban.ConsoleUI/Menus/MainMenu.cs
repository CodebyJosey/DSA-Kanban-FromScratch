...
namespace Kanban.ConsoleUI.Menus;
...
public sealed class MainMenu
{
    ...
    private void MoveTaskStatus()
    {
        ...
        Domain.Enums.TaskStatus status = AnsiConsole.Prompt(
            new SelectionPrompt<Domain.Enums.TaskStatus>()
                .Title("New status:")
                .AddChoices(new[] { Domain.Enums.TaskStatus.ToDo, Domain.Enums.TaskStatus.InProgress, Domain.Enums.TaskStatus.Done }));
